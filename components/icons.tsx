...
export const SettingsIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
      <path fillRule="evenodd" d="M11.828 2.25c-.916 0-1.699.663-1.85 1.567l-.091.549a.798.798 0 01-.517.608 7.51 7.51 0 00-1.846.504l-.491-.293c-.842-.502-1.823.225-1.823 1.141v.491l-.293.491c-.33.554-.756 1.052-1.242 1.488l-.491.293-.491.293v.491c0 .916.98 1.643 1.823 1.141l.491-.293a7.51 7.51 0 001.846.504.798.798 0 01.517.608l.091.549c.151.904.934 1.567 1.85 1.567h.344c.916 0 1.699-.663 1.85-1.567l.091-.549a.798.798 0 01.517-.608 7.51 7.51 0 001.846-.504l.491.293c.842.502 1.823-.225 1.823-1.141v-.491l.293-.491c.33-.554.756-1.052 1.242-1.488l.491-.293.491-.293v-.491c0-.916-.98-1.643-1.823-1.141l-.491.293a7.51 7.51 0 00-1.846-.504.798.798 0 01-.517-.608l-.091-.549A1.875 1.875 0 0012.172 2.25h-.344zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clipRule="evenodd" />
    </svg>
);